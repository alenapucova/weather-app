            ...
            <div className="singleDay" >
                {this.props.data && 
                    <div>
                        ...
                        <button className={"btn btn-primary" + (this.props.keys === 0 ? "" : " collapsed")} data-toggle="collapse" data-target={"#demo" + this.props.id}>
                            <span className="hideDetails">Hide details</span>
                            <span className="seeDetails">See details</span>
                        </button>
                        <div id={"demo" + this.props.id} className={"details collapse" + (this.props.keys === 0 ? " show" : "")}>
